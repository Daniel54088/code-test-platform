...
<img width=95% src="https://github.com/Daniel54088/code-test-platform/blob/main/media/laptop.png">


Shows the orders list under the `tablet` media screen

<img width=95% src="https://github.com/Daniel54088/code-test-platform/blob/main/media/tablet.png">

Shows the orders list under the `mobile` media screen

<img width=95% src="https://github.com/Daniel54088/code-test-platform/blob/main/media/mobile.png">
